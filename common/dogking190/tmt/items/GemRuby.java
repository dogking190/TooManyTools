...
public class GemRuby extends Item
    ...
    public GemRuby(int par1)
        {
            super(par1);
            this.setCreativeTab(tmt.tabTooManytools);
          this.setUnlocalizedName(Names.gemRuby_UnlocalizedName);
    ...
    public void registerIcons(IconRegister icon) {
        itemIcon = icon.registerIcon(Modinfo.ID.toLowerCase() + ":" + Names.gemRuby_UnlocalizedName);
            }

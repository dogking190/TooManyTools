...
public class IngotRuby extends Item
    ...
    public IngotRuby(int par1)
        {
            super(par1);
            this.setCreativeTab(tmt.tabTooManytools);
            this.setUnlocalizedName(Names.ingotRuby_UnlocalizedName);
            
        }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(IconRegister icon) {
        itemIcon = icon.registerIcon(Modinfo.ID.toLowerCase() + ":" + Names.ingotRuby_UnlocalizedName);
            }

...
public class SpadePlatinum extends ItemSpade
    {

    public SpadePlatinum(int par1, EnumToolMaterial par2EnumToolMaterial)
        {
    ...
    public void registerIcons(IconRegister icon) {
        itemIcon = icon.registerIcon(Modinfo.ID.toLowerCase() + ":" + Names.spadePlatinum_UnlocalizedName);
            }

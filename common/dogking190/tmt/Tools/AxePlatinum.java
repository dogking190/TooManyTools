...
public class AxePlatinum extends ItemAxe
    {

    public AxePlatinum(int par1, EnumToolMaterial par2EnumToolMaterial)
        {
    ...
    public void registerIcons(IconRegister icon) {
        itemIcon = icon.registerIcon(Modinfo.ID.toLowerCase() + ":" + Names.axePlatinum_UnlocalizedName);
            }
